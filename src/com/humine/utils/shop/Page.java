...
public class Page
{
	...
	public void setCosmetique(Cosmetique cosmetique, int slot)
	{
		if (this.cosmetiques.size() - 1 >= slot)
			this.cosmetiques.remove(slot);
	...
	{
		return this.cosmetiques.get(index);
	}

	public Cosmetique getLastCosmetique()
	{
		return this.cosmetiques.get(this.cosmetiques.size() - 1);
	}
