...
public class Page {
	...
	/**
	 * Classe permettant de stocker et d'afficher une liste de cosmetique depuis un inventaire
	 * @param name le nom de la page
	 * @param size la taille de la page (donc aussi de l'inventaire)
	 */
	 ...
	 * @return boolean renvoie vrai si le cosmetique a etait ajoute dans la page, sinon false
	 */
	 ...
	 * @param slot l'emplacement ou doit se trouver le cosmetique
	 * @param cosmetique le cosmetique a ajouter
	 * @return boolean renvoie vrai si le cosmetique a etait ajoute dans la page, sinon false
	 */
	 ...
	 * @param cosmetique le cosmetique a supprimer
	 * @return boolean renvoie vrai si le cosmetique a etait supprime de la page, sinon false
	 */
	...
	/**
	 * supprime un cosmetique de la page
	 * @param id l'id du cosmetique a supprimer
	 * @return boolean renvoie vrai si le cosmetique a etait supprime de la page, sinon false
	 */
	 ...
	 * @param cosmetique le cosmetique a verifier
	 * @return boolean renvoie vrai si le cosmetique a etait trouve de la page, sinon false
	 */
	...
	/**
	 * verifie si la page contient le cosmetique
	 * @param id l'id du cosmetique a verifier
	 * @return boolean renvoie vrai si le cosmetique a etait trouve de la page, sinon false
	 */
	 ...
	 * @param folder le dossier dans lequel la page sera enregistrer
	 */
	public void save(File folder) {
		...
		for(int i = 0; i < this.cosmetiques.length; i++) {
			if(this.cosmetiques[i] != null) {
				if(this.cosmetiques[i] instanceof ParticleCosmetique) {
					ParticleCosmetique c = (ParticleCosmetique) this.cosmetiques[i];
	 ...
	 * @param folder le dossier dans lequel la page sera chargee
	 */
	...
	/**
	 * @param cosmetiques les nouveaux cosmetiques de la page
	 */
